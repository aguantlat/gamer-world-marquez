...
const products = [
     ...
     `, 13000, 10, GHOST, videojuegos),
     new Product(4, 'FIFA 23', `FIFA es el videojuego de fútbol más vendido de la actualidad y con más de 25 años de desarrollo. Vas a poder jugar con tus equipos y futbolistas preferidos en diversos modos. ¡Preparate para convertirte en campeón de todas las copas y torneos!`, 15000, 15, FIFA, videojuegos),
     new Product(5, 'Playstation VR', `Personaliza el uso compartido de tu juego. Dado que cuenta con lentes duales para capturar a 1080p y un soporte integrado, la cámara HD funciona a la perfección con las herramientas de eliminación de fondos de la consola PS5 para ponerte en el centro de la atención.`, 150000, 2, PSVR, accesorios),
]
